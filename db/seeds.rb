...
racket1 = Racket.create!(brand:'Babolat', model:'Pure Drive', weight: 300,
  headsize: 645, length: 68.5, price: 219, balance: 320, color: 'blue', material: 'graphite', string_pattern: 1619, kid: false, adult: true, stiffness: 72, swingweight:290, play_type: "Power", players: "Fabio Fognini, Garbiñe Muguruza", description: "\t Some call it the definition of power. You will call it your unfair advantage. We call it the Pure Drive.\n  
...
# racket2 = Racket.create!(brand:'Babolat', model:'Pure Aero', weight: 300,
#   headsize: 645, length: 68.5, price: 210, balance: 320, color: 'yellow black', material: 'graphite', string_pattern: 1619, adult: true, stiffness: 71, swingweight:290)
...
user1 = User.create!(name:'marc', lastname: "Lachartre", username: "Kemar", rank:'pgm de la raquette', email: 'marc@gmail.com', password: 111111, admin: 1)
user2 = User.create!(name:'maxime', lastname: "Max", username: "Max", rank:'a deja sniffé de la terre battue', email: 'maxime@gmail.com', password: 111111, admin: 0)
user3 = User.create!(name:'yoann', lastname: "Robin", username: "Bendak", rank:'joue avec un planche (avaleur de sucette)', email: 'yoann@gmail.com', password: 111111, admin: 0)
user4 = User.create!(name:'benjamin', lastname: "Lacour", username: "Ramon", rank:'amis des parebrises', email: 'benjamin@gmail.com', password: 111111, admin: 0)
